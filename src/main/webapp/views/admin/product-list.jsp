                        ...
                        <tr>
                            ...
                            <td>
                                <c:choose>
                                    ...
                                    <c:when test="${fn:startsWith(product.image, 'http://') or fn:startsWith(product.image, 'https://')}"><img class="table-thumb" src="${fn:escapeXml(product.image)}" alt="${fn:escapeXml(product.productName)}"></c:when>
                                    <c:otherwise><img class="table-thumb" src="<c:url value='/image?fname=${product.image}'/>" alt="${fn:escapeXml(product.productName)}"></c:otherwise>
                                </c:choose>
                            </td>
